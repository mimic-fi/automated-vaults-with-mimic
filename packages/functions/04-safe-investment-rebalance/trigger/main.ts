...
async function main() {
    ...
    const manifest = {
        version: "2.0.3",
        name: "safe-investment-rebalance-function-event-cid",
        description: "safe-investment-rebalance-function-event-cid",
        inputs: {
            chainId: "uint32",
            USDC: "address",
    ...
    const params = {
        ...
        description: 'Safe Investment event triggered function',
        input,
        trigger,
        version: '0.0.6',
        manifest,
