...
export default function main(): void {
  log.info('initializing compound rewards claimer function')
  ...
  log.info('finished compound claimer function')
}
...
function claimCommetRewards(): void {
  ...
  //not accruing the balance, so we are able to swap all the tokens in this function
